...
void main() {
  runApp(MaterialApp(
    ...
    home: SplashScreen(), // Inicia con la pantalla de carga
            ...
            Navigator.of(context).pushReplacement(MaterialPageRoute(
              builder: (BuildContext context) {
                if (_isLoading) {
                  ...
                  // Puedes cambiar esto a la pantalla principal de la aplicación.
                  return Scaffold(
                    appBar: AppBar(title: Text('Abyssal Dungeon')),
                    body: Center(child: Text('Bievenido')),
                  );
                }
              },
            ));
